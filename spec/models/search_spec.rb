...
describe Search do
  ...
  it "should be usable on a Hash" do
    expect { @hash.extend(Search) }.to_not raise_error
  end

  it "should be able to extend nil" do
    pending "How do we test this without screwing up the environment? Nil is a singleton and we can't unmix modules."
    expect { nil.extend(Search) }.to_not raise_error
  end

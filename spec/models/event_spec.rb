...
describe Event do
  ...
  describe '.permitted_params' do
    subject { Event.permitted_params }

    [:calendar_id, :name, :description, :date, :site, :street, :street2, :city, :state_id, :zip].each do |field|
...
=end
  ...
  describe 'latitude and longitude' do # TODO: merge into geographical features context

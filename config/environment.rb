...
# Something to load fixtures in the right order...
...
# Can't put this in config/initializers because production.rb depends on it.
# TODO: refactor so that we can use initializers.
require 'yaml'

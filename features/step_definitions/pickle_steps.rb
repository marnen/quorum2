# this file generated by script/generate pickle, but modified manually
...
Given /^no #{capture_plural_factory} exist/ do |name|
  name.classify.constantize.destroy_all
end
...
Then /^(\d+) (#{capture_model}|#{capture_plural_factory}) should exist$/ do |count, name, _, _|
  find_models(name.singularize).count.should == count.to_i
end
